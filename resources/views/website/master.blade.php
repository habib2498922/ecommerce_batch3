...
<head>
    ...
    <!--Frontawesome css-->
    <link href="{{asset('/')}}website/assets/css/all.css" rel="stylesheet" />
</head>
<body>
<!--[if lte IE 9]>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="top-end">
                        ...
                        @else
                            <ul class="user-login">
                                <li>
                                    <a href="{{route('customer_login')}}">Sign In</a>
                                </li>
                                <li>
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="{{route('show-cart')}}"><img src="{{asset($cartproduct->attributes->image)}}" alt="#"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="{{route('show-cart')}}">{{$cartproduct->name}}</a></h4>
                                                <p class="quantity" >{{$cartproduct->quantity}} * <span class="amount">{{$cartproduct->price}}</span></p>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{asset('/')}}website/assets/js/bootstrap.min.js"></script>
