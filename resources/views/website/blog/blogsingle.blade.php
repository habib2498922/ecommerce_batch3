                    ...
                    <div class="post-details">
                        <div class="main-content-head">
                            <div class="post-thumbnils">
                                <img src="{{asset('/')}}website/assets/images/blog/blog-single.jpg" alt="#">
                            </div>
                            ...
                            <ul class="comments-list">
                                <li>
                                    <div class="comment-img">
                                        <img src="{{asset('/')}}website/assets/images/blog/comment1.jpg" alt="img">
                                    </div>
                                ...
                                <li class="children">
                                    <div class="comment-img">
                                        <img src="{{asset('/')}}website/assets/images/blog/comment2.jpg" alt="img">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="desc-top">
                                ...
                                <li>
                                    <div class="comment-img">
                                        <img src="{{asset('/')}}website/assets/images/blog/comment3.jpg" alt="img">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="desc-top">
                                            <h6>Alex Jemmi</h6>
