                       ...
                       <div class="xzoom-container">
                           ...
                           <div class="xzoom-thumbs">
                               ...
                               <a href="{{asset($subImage->image)}}">
                                   <img class="xzoom-gallery" width="80" src="{{asset($subImage->image)}}" xpreview="{{asset($subImage->image)}}"/></a>
                               @endforeach
                           </div>
                       </div>
                        @else
                            <div class="xzoom-container">
                                ...
                                <div class="xzoom-thumbs">
                                        <a href="{{asset($product->image)}}">
                                            <img class="xzoom-gallery" width="80" src="{{asset($product->image)}}"  xpreview="{{asset($product->image)}}"/></a>
                                </div>
                            </div>
                        @endif
                    </div>
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag">
                                </i> Product Category Name:<a href="javascript:void(0)">{{$product->category->name}}
                                </a></p>
                            <p class="category"><i class="lni lni-tag">
                                </i> Product Brand Name:<a href="javascript:void(0)">{{$product->brand->name}}
                                </a></p>
                            <h3 class="price"><span> &#2547 </span> {{$product->selling_price}}<span>
                                    <span> &#2547 </span> {{$product->regular_price}}</span></h3>
